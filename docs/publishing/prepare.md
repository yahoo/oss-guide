...
- Don't use a name that is protected by trademark. We'll connect you to our Trademark Search Request process if you are unsure about the protected status of the name you propose.
- Don't use a copmany brand name.
...
- We're a complicated company, so many groups get stuck on who the copyright holder is for their code. We'll guide you as to the appropriate choice.
